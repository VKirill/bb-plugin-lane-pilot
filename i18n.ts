...
const chromeEn = {
  ...
  nightReviewAutoMerge: "Merge only verified, approved managed-worktree changes",
  ...
  memoryPicker: "Memory maintenance provider and model",
  memoryPickerHelp: "Choose the native provider and model used to maintain this project's memory after an accepted task.",
  docsPicker: "Documentation maintenance provider and model",
  docsPickerHelp: "Choose the native provider, model, reasoning level, and service tier used by manual and scheduled documentation maintenance.",
  configureDocsPicker: "Configure docs-maintenance model",
  closeDocsPicker: "Close docs-maintenance model settings",
  onboardingPicker: "Project onboarding preview provider and model",
  onboardingPickerHelp: "Choose the native provider, model, reasoning level, and service tier used to create a read-only onboarding preview.",
...
const chromeRu: { [K in keyof typeof chromeEn]: string } = {
  ...
  nightReviewAutoMerge: "Сливать только проверенные изменения из одобренной управляемой рабочей копии",
  ...
  memoryPicker: "Провайдер и модель обслуживания памяти",
  memoryPickerHelp: "Выберите native-провайдера и модель для обновления памяти проекта после принятой задачи.",
  docsPicker: "Провайдер и модель обслуживания документации",
  docsPickerHelp: "Выберите native-провайдера, модель, уровень рассуждений и тариф для ручного и планового обслуживания документации.",
  configureDocsPicker: "Настроить модель обслуживания документации",
  closeDocsPicker: "Закрыть настройки модели документации",
  onboardingPicker: "Провайдер и модель onboarding preview проекта",
  onboardingPickerHelp: "Выберите native-провайдера, модель, уровень reasoning и тариф для read-only предварительного обзора проекта.",

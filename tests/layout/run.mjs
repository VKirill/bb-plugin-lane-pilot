            ...
            <fieldset class="min-w-0 max-w-full space-y-6" style="min-inline-size:0">
              <section class="min-w-0 max-w-full rounded-lg border ${dark ? "border-neutral-800 bg-neutral-900" : "border-neutral-200 bg-white"}">
                ...
                <div class="space-y-3 px-3 pb-3 pt-2">
                  ...
                  <select id="owned-agent" class="min-h-11 min-w-0 w-full max-w-full box-border rounded-md border ${dark ? "border-neutral-700 bg-neutral-950" : "border-neutral-300"}"><option>${escapeHtml(profile.displayName)}</option></select>
                  <label class="text-sm" for="agent-description">${l.name}</label>
                  <input id="agent-description" class="min-h-11 min-w-0 w-full max-w-full box-border rounded-md border ${dark ? "border-neutral-700 bg-neutral-950" : "border-neutral-300"}" value="${escapeHtml(profile.displayName + " — " + profile.tools[0])}" />
                </div>
              </section>
              <section class="min-w-0 max-w-full rounded-lg border ${dark ? "border-neutral-800 bg-neutral-900" : "border-neutral-200 bg-white"}">
              ...
              <section class="min-w-0 max-w-full rounded-lg border ${dark ? "border-neutral-800 bg-neutral-900" : "border-neutral-200 bg-white"}" data-testid="agent-resource-skills">
                <div class="flex items-center justify-between gap-2 px-3 pb-3 pt-3">
                  ...
                  <select class="h-8 w-[11rem] min-w-0 max-w-full shrink-0 rounded-md border ${dark ? "border-neutral-700 bg-neutral-950" : "border-neutral-300"}" aria-label="${l.skills}"><option>${l.inherit}</option></select>
                </div>
              </section>
              <section class="min-w-0 max-w-full rounded-lg border ${dark ? "border-neutral-800 bg-neutral-900" : "border-neutral-200 bg-white"}" data-testid="agent-resource-tools">
                <div class="flex items-center justify-between gap-2 px-3 pt-3">
                  ...
                  <select class="h-8 w-[11rem] min-w-0 max-w-full shrink-0 rounded-md border ${dark ? "border-neutral-700 bg-neutral-950" : "border-neutral-300"}" aria-label="${l.tools}"><option>${l.selected}</option></select>
                </div>

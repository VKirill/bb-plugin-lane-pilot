...
describe("code critique policy", () => {
  ...
  it("refuses a second repair send when the round was claimed without a thread id", () => {
    expect(nextRepairAction({
      nextRound:1, revisionSha256:"abc",
      ledger:{ artifactRevisionSha256:"abc", revisionSha256:"abc", findingsHash:"f", repairRound:1, spawnAttempted:true },
    })).toBe("unknown");
    expect(nextRepairAction({
      nextRound:1, revisionSha256:"abc",
      ledger:{ artifactRevisionSha256:"abc", revisionSha256:"abc", findingsHash:"f", repairRound:1, spawnAttempted:true, repairThreadId:"thr_repair" },
    })).toBe("wait");
